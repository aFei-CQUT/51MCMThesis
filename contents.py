...
def write_directory_contents_to_file(
    scan_directory, output_directory, output_file_name, exclude_folders=None
):
    """
    ...
    with open(output_file_path, "w", encoding="utf-8") as output_file:
        ...
        directory_structure = generate_directory_structure(
            current_dir, exclude_folders=exclude_folders
        )
        ...
        for root, dirs, files in os.walk(current_dir):
            ...
            files = [
                ...
                for f in files
                if not (
                    any(f.endswith(ext) for ext in IGNORE_EXTENSIONS)
...
if __name__ == "__main__":
    ...
    write_directory_contents_to_file(
        scan_directory, output_directory, output_file_name, exclude_folders
    )
